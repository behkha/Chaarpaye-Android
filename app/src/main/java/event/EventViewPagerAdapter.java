...
public class EventViewPagerAdapter extends PagerAdapter {
    ...
    public EventViewPagerAdapter(Context mContext, ArrayList<Media> medias) {
...
//        View view = inflater.inflate(R.layout.event_view_pager_item_layout,null);
//        ImageView image = view.findViewById(R.id.event_view_pager_item_image);
